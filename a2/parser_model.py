...
class ParserModel(nn.Module):
    ...
    def embedding_lookup(self, w):
        ...
        x = x.reshape(x.shape[0], x.shape[1] * x.shape[2])  # (batch_size, n_features * embed_size)
    ...
    def forward(self, w):
        ...
        logits = None
        w = self.embedding_lookup(w)  # (batch_size, n_features * embed_size)
        hidden = torch.matmul(w, self.embed_to_hidden_weight) + self.embed_to_hidden_bias  # (batch_size, hidden_size)
